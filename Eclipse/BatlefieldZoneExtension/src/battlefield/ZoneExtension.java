...
public class ZoneExtension extends SFSExtension  
{
	...
	{
		if(!TableExists("sfs2x","BG_ArmyInventory"))
		{
	...
	{
		if(!TableExists("sfs2x","BG_CraftInventory"))
		{
	...
	void InitCipherTable()
	{
		...
		{
			String sql = "CREATE TABLE BG_Cipher (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, playerID INT UNSIGNED NOT NULL, race TINYINT UNSIGNED, cipher VARCHAR(26) NOT NULL, seed VARCHAR(100), INDEX(playerID));";
	        try
	        {
	        	sfs2xDBManager.executeInsert(sql, new Object[] {});
